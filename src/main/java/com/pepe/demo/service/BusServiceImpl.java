...
//         // 변환된 날짜를 이용하여 데이터베이스에서 버스 목록을 검색하는 로직 추가
//         List<BusDto> busList = busDao.getBusListByDate(selectedDate);
//         return busList;
//     }

//     @Override
// public List<BusDto> getBusListByDate(String selectedDate) {
//     List<BusDto> busList = busDao.getBusListByDate(selectedDate);
//     return busList;
// }
